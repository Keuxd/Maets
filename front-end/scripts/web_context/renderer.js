...
const { LoginResponseHandler, isValidEmail } = require('./scripts/web_context/auth');
const { JavaWeb } = require("./scripts/web_context/JavaWeb");
    ...
    switch (response.type) {
        ...
        case "Library":
       	...
       	case "Availability" :			
			...
			//const mainWindow = ipcRenderer.sendSync("get-main-window");
...
function download(gameId) {
	...
	ipcRenderer.send("send-to-backend", "availability " + gameId);
}
